...
#### 3.1. Анализ базовых требований (Basic Requirements Analysis)
...
Другим примером является шаблон спецификации варианта использования, как показано на рисунке 1.6.
...
ATDD является частью более широкого подхода к разработке на основе тестирования (TDD). (см. раздел "Тестирование программного обеспечения"). Основная идея TDD заключается в том, что тестовые примеры предшествуют созданию. Таким образом, новый производственный код не пишется и существующий код не модифицируется до тех пор, пока хотя бы один тестовый пример не завершится неудачей либо на уровне модульного тестирования, либо на уровне приемочного тестирования. Процесс ATDD состоит из трех этапов:
...
#### 4.6. Дополнительные и всеобъемлющие требования; Спецификация (4.6.Incremental and Comprehensive Requirements Specification)
